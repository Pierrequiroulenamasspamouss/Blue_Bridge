...
#TODO: fix to use the new database arrangement and work properly
#TODO 2 : create a tool for managing the user deviceToken
#TODO 3 : create a wrapper tool python script for users, wells and data (global tool)
