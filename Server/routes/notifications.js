...
//TODO : fix the fact that it desn't use the correct database layout ( current  = 3 databses : users, wells and user tokens
/**
        ...
        if (!deviceTokens.includes(deviceToken)) {
            ...
            try {
                await sendPushNotification(
                    ...
                    'You will now receive notifications from BlueBridge!'
                );
