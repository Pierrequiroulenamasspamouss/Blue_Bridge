...
openssl req -x509 -new -nodes -key "$SSL_DIR/ca_key.key" -sha256 -days 3650 -out "$SSL_DIR/ca_cert.crt" -subj "/C=FR/ST=IDF/L=Paris/O=WellConnect CA/OU=Development/CN=WellConnect Root CA"
