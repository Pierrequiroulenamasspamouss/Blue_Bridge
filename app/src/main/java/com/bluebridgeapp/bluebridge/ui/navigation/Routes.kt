...
object Routes {
    ...
    const val NOTIFICATION_DEBUG_SCREEN = "notification_debug_screen"
    ...
    const val BROWSE_WELLS_SCREEN = "well_picker_screen"
    const val WELL_DETAILS_SCREEN = "well_details_screen"
    const val WELL_CONFIG_SCREEN = "well_config_screen"
