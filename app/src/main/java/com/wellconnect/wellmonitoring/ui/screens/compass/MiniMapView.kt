...
// Clean up or delete these unused helper functions
// private fun addUserMarker(context: Context, mapView: MapView, lat: Double, lon: Double) {
//     val userMarker = Marker(mapView).apply {
//         position = GeoPoint(lat, lon)
//         setAnchor(Marker.ANCHOR_CENTER, Marker.ANCHOR_BOTTOM)
//         title = "Your Location"
//         icon = ContextCompat.getDrawable(context, R.drawable.small_user_location_icon)
//     }
//     mapView.overlays.add(userMarker)
// }
// 
// private fun addTargetMarker(context: Context, mapView: MapView, lat: Double, lon: Double) {
